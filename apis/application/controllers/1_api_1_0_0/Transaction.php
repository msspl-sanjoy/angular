                ...
                if(!empty($login_status_arr) && count($login_status_arr) > 0){
                    ...
                    if($productDtl['product_type']=='P'){
                        ...
                        $loan_disbursed['actual_loan_p']=$req_arr['product_amount'];
                         ...
                         $loan_disbursed['pAngular_ufa']=$productVarientDtl['calc_ufa'];
                         $loan_disbursed['pAngular_stufa']=$productVarientDtl['calc_stufa'];
                         $loan_disbursed['pAngular_rufa']=$productVarientDtl['calc_rufa'];
